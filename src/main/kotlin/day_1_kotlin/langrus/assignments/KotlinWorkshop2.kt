...
object KotlinWorkshop2 {
    ...
    fun main(args: Array<String>) {
        ...
        while (true) {
            ...
            if (true) {
                if (userInput == randomNumber){
                    println("Поздравляю! Задуманное число $userInput")
                    break
                }
                if (userInput<randomNumber){
                    println("Ваше число меньше задуманного, пожалуйста продолжаем.")
                }
                else println("Ваше число больше задуманного, пожалуйста продолжаем.")
        ...
        val numbersArray = arrayListOf<Int>(1, 2, 3, 4, 5)
        ...
        while (counter<size) {
            ...
            when (userInput){
                ...
                5 -> numbersArray[counter] = userInput * 5
                9 -> numbersArray[counter] = userInput + 2
                else -> { }
            }
