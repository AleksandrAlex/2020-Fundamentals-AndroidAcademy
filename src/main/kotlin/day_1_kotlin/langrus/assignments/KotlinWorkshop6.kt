...
// TODO 1: Добавь в data class 2-4 свойства.
 data class VideoGame(val title: String, val year: Int)
 ...
 object VideoGamesTest {
    ...
    fun main(args: Array<String>)  {
        ...
        //  Создай копию игры с помощью функции ата класса ".copy()", сохрани копию в другой переменной.
         val game = VideoGame("Heroes 3", 1999)
         val copy = game.copy(year =  2000)
        ...
        val games = arrayOf(game, copy, VideoGame("Doom", 1994), VideoGame("Сапёр", 1990))
        games.forEach {
            println(it)
        }
    }
